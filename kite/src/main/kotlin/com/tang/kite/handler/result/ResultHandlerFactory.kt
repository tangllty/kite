...
import com.tang.kite.handler.result.primitive.ByteResultHandler
import com.tang.kite.handler.result.primitive.CharResultHandler
import com.tang.kite.handler.result.primitive.DoubleResultHandler
import com.tang.kite.handler.result.primitive.FloatResultHandler
import com.tang.kite.handler.result.primitive.IntResultHandler
import com.tang.kite.handler.result.primitive.LongResultHandler
import com.tang.kite.handler.result.primitive.ShortResultHandler
import com.tang.kite.handler.result.primitive.StringResultHandler
import com.tang.kite.handler.result.time.CalendarResultHandler
import com.tang.kite.handler.result.time.DateResultHandler
import com.tang.kite.handler.result.time.InstantResultHandler
import com.tang.kite.handler.result.time.LocalDateResultHandler
import com.tang.kite.handler.result.time.LocalDateTimeResultHandler
import com.tang.kite.handler.result.time.LocalTimeResultHandler
import com.tang.kite.handler.result.time.SqlDateResultHandler
import com.tang.kite.handler.result.time.TimeResultHandler
import com.tang.kite.handler.result.time.TimestampResultHandler
